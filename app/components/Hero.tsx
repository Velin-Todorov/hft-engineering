export default function Hero() {
  return (
    <section className="bg-linear-to-br from-gray-900 to-gray-800 py-16 text-center relative overflow-hidden">
      <div
      ...
      <div className="max-w-6xl mx-auto px-5 relative z-10">
        <h1 className="text-5xl md:text-6xl font-bold mb-4 bg-linear-to-r from-cyan-400 to-green-400 bg-clip-text text-transparent font-mono">
